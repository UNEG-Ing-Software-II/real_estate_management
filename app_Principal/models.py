...
class Telefono(models.Model):
    ...
    persona = models.ForeignKey(Usuario,on_delete=models.CASCADE) #FK la tabla Usuario
    telefono = models.CharField(max_length=15) #numero de contacto, tipo char porque puede tener +58 y asi
...
class Inmueble(models.Model):
    ...
    id = models.UUIDField(primary_key=True)
    propietario = models.ForeignKey(Usuario,on_delete=models.CASCADE) #FK la tabla Usuario
...
class Documentos(models.Model):  #documentos del inmueble
    id = models.UUIDField(primary_key=True)
    asesor = models.ForeignKey(Usuario,on_delete=models.CASCADE) #FK la tabla Usuario
...
class Area(models.Model):
    id = models.UUIDField(primary_key=True)
    inmueble = models.ForeignKey(Inmueble,on_delete=models.CASCADE) #FK la tabla Inmueble
    tipo = models.CharField( #seleccion de tipo de area, definido en la linea 3
        max_length=20,
...
class Area_caracteristicas(models.Model):
    ...
    caracteristica = models.ForeignKey(Caracteristica,on_delete=models.CASCADE) #FK la tabla Area
