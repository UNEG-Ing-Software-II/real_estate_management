...
urlpatterns = [
    ...
    path(
        "inicio_director_general",
        director_general,
        name="inicio Director General",
    ),
    ...
    path(
        ...
        inmuebles_registrados,
        name="inmuebles registrados",
    ),  # Leer
    path(
        "registrar-inmueble/", registrar_inmueble, name="registrar_inmueble"
    ),  # Crear
    path(
        "modificar_inmueble/<uuid:inmueble_id>/",
        modificar_inmueble,
        name="modificar_inmueble",
    ),
    path(
        "eliminar_inmueble/<uuid:inmueble_id>/",
        eliminar_inmueble,
        name="eliminar_inmueble",
    ),
]
